          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href={"/trips"}>
                  <button
                    className={`border-2 p-2 rounded-xl text-white bg-blue-600 hover:bg-blue-800 hover:cursor-pointer ${
                      !isLoggedIn ? "hidden" : ""
                    }`}
                  >
                    View my trips
        ...
        <section className="py-16 md:py-24 bg-gray-800">
          <div className="container mx-auto px-4 text-center">
            ...
            <AuthButton
              ...
              className="inline-block bg-white text-gray-800 hover:bg-blue-50 px-6 py-3 rounded-lg transition-colors duration-200 hover:cursor-pointer"
            >
